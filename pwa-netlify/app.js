...
const API=localStorage.getItem('tamsApi')||'https://tams-ochre.vercel.app';const $=id=>document.getElementById(id);let flights=JSON.parse(localStorage.getItem('tamsFlights')||'[]');
